...
func New(dir string) *six.App {
	var (
		db       = tmdb.NewMemDB()
		logger   = log.NewNopLogger()
		encoding = six.MakeEncodingConfig()
	)

	a := six.New(logger, db, nil, true, map[int64]bool{}, dir, 0, encoding,
		simapp.EmptyAppOptions{}, six.GetWasmEnabledProposals(), six.EmptyWasmOpts)
